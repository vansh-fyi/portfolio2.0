      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="flex flex-col md:flex-row gap-4 gap-x-4 gap-y-4 items-center justify-between">
          ...
          <div className="flex gap-4 text-sm gap-x-2 gap-y-4 items-center">
            <a href="https://linkedin.com/in/yourname" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 transition active:scale-95 hover:bg-white/10 hover:ring-white/20 text-sm font-medium text-white/80 font-geist bg-white/5 ring-white/10 ring-1 rounded-full pt-2 pr-3.5 pb-2 pl-3.5 backdrop-blur-sm" aria-label="LinkedIn">
            ...
            <a href="https://github.com/yourname" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 transition active:scale-95 hover:bg-white/10 hover:ring-white/20 text-sm font-medium text-white/80 font-geist bg-white/5 ring-white/10 ring-1 rounded-full pt-2 pr-3.5 pb-2 pl-3.5 backdrop-blur-sm" aria-label="GitHub">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="w-[18px] h-[18px]">
            ...
            <a href="https://github.com/yourname" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 transition active:scale-95 text-sm font-medium font-geist ring-1 rounded-full pt-2 pr-3.5 pb-2 pl-3.5 backdrop-blur-sm hover:bg-white/10 hover:ring-white/20 text-white/80 bg-white/5 ring-white/10" aria-label="GitHub">
