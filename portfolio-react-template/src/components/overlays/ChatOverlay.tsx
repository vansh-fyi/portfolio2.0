...
const ChatOverlay: React.FC<ChatOverlayProps> = ({ onClose, isVisible }) => {
  ...
  return (
    <div className="fixed inset-0 z-40 pt-[84px] px-6 md:px-8 pb-6">
      ...
      <div className="z-10 relative">
        <div className="overflow-hidden h-[calc(100vh-84px-24px)] flex flex-col bg-neutral-900/80 ring-white/20 ring-1 rounded-2xl shadow-[0_20px_120px_-20px_rgba(0,0,0,0.7)] backdrop-blur-md">
          {/* Desktop chrome */}
          ...
          <div className="grid grid-cols-12 flex-1 min-h-0">
                  ...
                  <div className="space-y-3">
                    <div className="pr-1 pl-2 space-y-5">
                      <ul className="space-y-1">
                        ...
                        <li className="">
                          <a href="#" className="group flex items-top gap-2 bg-white/10 ring-white/10 active:scale-95 text-sm text-white/80 ring-transparent ring-1 rounded-lg pt-2 pr-3 pb-2 pl-3 relative">
            ...
            <section className="col-span-12 md:col-span-9 lg:col-span-9 min-h-0 flex flex-col relative" id="main-content">
              <div className="flex flex-col min-h-0 h-full relative">
                {/* Thread area (now the only scrollable area) */}
                <div className="flex-1 overflow-y-auto sm:px-8 pt-8 pr-4 pb-8 pl-4 space-y-6">
                  {/* User message */}
                  <div className="flex gap-x-3 gap-y-3 items-start justify-end">
                    <div className="text-sm bg-white/5 max-w-[75%] ring-white/10 ring-1 rounded-2xl pt-2.5 pr-4 pb-2.5 pl-4 shadow-sm backdrop-blur-sm">
                      <p className="text-white">
                        Can you show the images of the UI in this project.
                      </p>
                    </div>
                    <div className="inline-flex transition text-white/80 bg-white/10 w-8 h-8 ring-white/10 ring-1 rounded-full items-center justify-center">
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" data-lucide="circle-user" className="lucide lucide-circle-user lucide-user w-[18px] h-[18px]">
                        <circle cx="12" cy="12" r="10"></circle>
                  ...
                  <div className="flex gap-x-3 gap-y-3 items-start">
                    <div className="flex flex-shrink-0 text-xs font-medium text-white bg-white/10 w-8 h-8 rounded-full ring-white/10 ring-1 items-center justify-center">
                      AI
                    </div>
                    <div className="relative">
                      <div className="text-sm bg-black/30 max-w-[680px] ring-white/10 ring-1 rounded-2xl pt-3 pr-4 pb-3 pl-4 shadow backdrop-blur-sm">
                        <p className="text-white">Absolutely! Here are the images highlighting user interfaces
                          used
                          in this particular project (PROJECT NAME) created by Vansh Grover.</p>
                      </div>
                  ...
                  {/* Image strip */}
                  <div className="flex overflow-x-auto overflow-y-hidden pl-11 gap-x-5 gap-y-5 items-end">
                    <img className="aspect-[3/4] flex-shrink-0 cursor-pointer hover:scale-95 transition-transform duration-200 w-44 object-cover ring-black/50 ring-1 rounded-2xl shadow-xl" src="https://images.unsplash.com/photo-1621619856624-42fd193a0661?w=1080&amp;q=80" />
                    <img className="aspect-[3/4] flex-shrink-0 cursor-pointer hover:scale-95 transition-transform duration-200 w-44 object-cover rounded-2xl ring-black/50 ring-1 shadow-xl" src="https://images.unsplash.com/photo-1642615835477-d303d7dc9ee9?w=1080&amp;q=80" />
                    <img className="aspect-[3/4] flex-shrink-0 cursor-pointer hover:scale-95 transition-transform duration-200 w-44 object-cover rounded-2xl ring-black/50 ring-1 shadow-xl" src="https://images.unsplash.com/photo-1635151227785-429f420c6b9d?w=1080&amp;q=80" />
                  </div>

                  {/* User follow-up */}
                  <div className="flex items-start gap-3 justify-end">
                    <div className="rounded-2xl bg-white/5 backdrop-blur-sm text-sm px-4 py-2.5 max-w-[75%] shadow-sm ring-1 ring-white/10">
                      <p className="text-white">Perfect! Can you tell me more in detail about the process used.</p>
                    </div>
                    <div className="inline-flex transition text-white/80 bg-white/10 w-8 h-8 ring-white/10 ring-1 rounded-full items-center justify-center">
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" data-lucide="circle-user" className="lucide lucide-circle-user lucide-user w-[18px] h-[18px]">
                        <circle cx="12" cy="12" r="10"></circle>
                  ...
                  <div className="flex gap-3 gap-x-3 gap-y-3 items-center">
                    <div className="flex h-8 w-8 items-center justify-center rounded-full bg-white/10 text-xs font-medium ring-1 ring-white/10 text-white">
                      AI
                    </div>
                  ...
                  <div className="sm:p-4 bg-black/30 w-full ring-white/20 ring-1 rounded-2xl mr-auto ml-auto pt-3 pr-3 pb-3 pl-3 shadow-2xl backdrop-blur-xl">
                    <div className="flex items-end gap-2 sm:gap-3">
                      <div className="relative flex-1">
                        <textarea rows={2} className="resize-none focus:outline-none text-sm text-slate-200 bg-transparent w-full rounded-xl pt-2.5 pr-3 pb-2.5 pl-3" placeholder="Ask anything about the project in detail..."></textarea>
                        <div className="pointer-events-none absolute inset-x-0 bottom-0 h-px bg-gradient-to-r from-transparent via-white/10 to-transparent">
                        </div>
                      </div>
                      <div className="flex gap-2 sm:gap-3 gap-x-2 gap-y-2 items-center">
                        <button className="inline-flex hover:bg-white active:scale-95 text-sm font-medium text-black bg-white/80 rounded-xl pt-2.5 pr-4 pb-2.5 pl-4 items-center justify-center">
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" data-lucide="send" className="lucide lucide-send w-[16px] h-[16px] mr-1.5 text-black">
