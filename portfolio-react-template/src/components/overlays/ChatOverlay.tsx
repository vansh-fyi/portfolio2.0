            ...
            <aside className="hidden md:block md:col-span-3 lg:col-span-3 min-h-0 h-full border-white/5 border-r" id="sidebar">
              ...
              <div class="sm:p-6 border-white/10 border-t pt-4 pr-4 pb-4 pl-4">
                <div class="flex items-center gap-3 rounded-xl bg-black/80 p-3 ring-1 ring-white/10">
                  <div class="inline-flex transition active:scale-95 text-white/80 bg-white/10 w-8 h-8 rounded-full ring-white/10 ring-1 items-center justify-center flex-shrink-0" alt="AI Agent">
              ...
              <div className="flex flex-col min-h-0 h-full relative">
                ...
                <div className="flex-1 overflow-y-auto sm:px-8 pt-8 pr-4 pb-8 pl-4 space-y-6">
                  ...
                  <div className="flex overflow-x-auto overflow-y-hidden pl-11 gap-x-5 gap-y-5 items-end">
                    <img className="aspect-[3/4] flex-shrink-0 cursor-pointer hover:scale-95 transition-transform duration-200 w-44 object-cover ring-black/50 ring-1 rounded-2xl shadow-xl" src="https://images.unsplash.com/photo-1621619856624-42fd193a0661?w=1080&amp;q=80" alt="concept 1" />
                    <img className="aspect-[3/4] flex-shrink-0 cursor-pointer hover:scale-95 transition-transform duration-200 w-44 object-cover rounded-2xl ring-black/50 ring-1 shadow-xl" src="https://images.unsplash.com/photo-1642615835477-d303d7dc9ee9?w=1080&amp;q=80" alt="concept 2" />
                    <img className="aspect-[3/4] flex-shrink-0 cursor-pointer hover:scale-95 transition-transform duration-200 w-44 object-cover rounded-2xl ring-black/50 ring-1 shadow-xl" src="https://images.unsplash.com/photo-1635151227785-429f420c6b9d?w=1080&amp;q=80" alt="concept 3" />
                  </div>
