            ...
            <aside className="hidden md:block md:col-span-3 lg:col-span-3 min-h-0 h-full border-white/5 border-r" id="sidebar">
              ...
              <div className="sm:p-6 border-white/10 border-t pt-4 pr-4 pb-4 pl-4">
                <div className="flex items-center gap-3 rounded-xl bg-black/80 p-3 ring-1 ring-white/10">
                  <div className="inline-flex transition active:scale-95 text-white/80 bg-white/10 w-9 h-9 rounded-md ring-white/5 ring-1 items-center justify-center flex-shrink-0">
