...
const Projects = () => {
  const { openProjectOverlay } = useOverlayStore();
  return (
    <section className="scroll-animate lg:py-24 in-view pt-20 pb-20 relative" id="projects">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-12 gap-x-6 gap-y-6">
          {/* Project 1 */}
          <div onClick={openProjectOverlay} className="group relative overflow-hidden rounded-2xl aspect-[2 /3] border ring-1 md:col-span-2 lg:row-span-2 card-shine hover-glow active:scale-95 border-white/10 ring-white/5">
            <img src="https://images.unsplash.com/photo-1642615835477-d303d7dc9ee9?w=1080&q=80" alt="Abstract Portrait" className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105" />
          ...
          <div onClick={openProjectOverlay} className="group relative overflow-hidden rounded-2xl aspect-[4/3] border ring-1 card-shine hover-glow active:scale-95 border-white/10 ring-white/5">
          ...
          {/* Project 3 */}
          <div onClick={openProjectOverlay} className="group overflow-hidden aspect-auto border ring-1 rounded-2xl relative lg:row-span-2 md:row-span-3 xs:row-span-1 card-shine hover-glow active:scale-95 border-white/10 ring-white/5">
            <img src="https://images.unsplash.com/photo-1621619856624-42fd193a0661?w=1080&q=80" alt="Surreal Landscape" className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105" />
            <div className="group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-t via-transparent to-transparent opacity-0 absolute top-0 right-0 bottom-0 left-0 from-black/60"></div>
            <div className="absolute bottom-4 left-4 right-4 transform translate-y-4 group-hover:translate-y-0 opacity-0 group-hover:opacity-100 transition-all duration-300">
              <div className="backdrop-blur-xl rounded-xl p-4 ring-1 bg-black/30 ring-white/10">
          ...
          {/* Project 5 */}
          <div onClick={openProjectOverlay} className="group relative overflow-hidden rounded-2xl aspect-[4/3] border ring-1 card-shine hover-glow active:scale-95 border-white/10 ring-white/5">
            <img src="https://images.unsplash.com/photo-1635151227785-429f420c6b9d?w=1080&q=80" alt="Digital Art" className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105" />
            <div className="group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-t via-transparent to-transparent opacity-0 absolute top-0 right-0 bottom-0 left-0 from-black/60"></div>
            <div className="absolute bottom-4 left-4 right-4 transform translate-y-4 group-hover:translate-y-0 opacity-0 group-hover:opacity-100 transition-all duration-300">
              <div className="backdrop-blur-xl rounded-xl p-4 ring-1 bg-black/30 ring-white/10">
                <h4 className="font-semibold mb-1 text-white">
        ...
        <div className="text-center">
          <button onClick={openProjectOverlay} className="group inline-flex transition-all duration-300 card-shine hover-glow hover:bg-white/10 hover:border-white/30 text-base font-medium text-white/80 bg-white/5 border-white/10 border rounded-2xl pt-4 pr-8 pb-4 pl-8 backdrop-blur-xl gap-x-3 gap-y-3 items-center">
