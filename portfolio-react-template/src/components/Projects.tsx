    ...
    <section className="scroll-animate lg:py-24 in-view pt-20 pb-20 relative" id="projects">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-12 gap-x-6 gap-y-6">
          {/* Project 1 */}
          <div className="group relative overflow-hidden rounded-2xl aspect-[2 /3] border ring-1 md:col-span-2 lg:row-span-2 card-shine hover-glow active:scale-95 border-white/10 ring-white/5">
          ...
          {/* Project 3 */}
          <div className="group overflow-hidden aspect-auto border ring-1 rounded-2xl relative lg:row-span-2 md:row-span-3 xs:row-span-1 card-shine hover-glow active:scale-95 border-white/10 ring-white/5">
        ...
        <div className="text-center">
          <button className="group inline-flex transition-all duration-300 card-shine hover-glow hover:bg-white/10 hover:border-white/30 text-base font-medium text-white/80 bg-white/5 border-white/10 border rounded-2xl pt-4 pr-8 pb-4 pl-8 backdrop-blur-xl gap-x-3 gap-y-3 items-center">
